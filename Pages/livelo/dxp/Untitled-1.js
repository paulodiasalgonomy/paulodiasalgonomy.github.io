...
function recsCarousel() {
    ...
    function buildProducts(products) {
        var html = '<div id="dxp-carrossel" class="owl-carousel owl-theme"><div id="dxp-title"><p>Oferta Relâmpago</p><p>Termina em <span id="dxp-hours"></span><span id="dxp-mins"></span><span id="dxp-secs"></span></p></div>';
...
$(document).ready(function(){
  recsCarousel();
  let algonomyOwlInterval = setInterval(() => {
  let el = $("#dxp-carrossel");
  if (typeof el.owlCarousel === 'function') {
    clearInterval(algonomyOwlInterval);
  }
}, 1000);
});