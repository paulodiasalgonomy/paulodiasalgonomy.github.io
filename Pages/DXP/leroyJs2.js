    ...
    function buildProducts(products) {
        ...
        for (var i = 0, len = products.length; i < len; i++) {
			...
			<div class="item-price">
			  <%= items_currency %>${(parseFloat(products[i].priceCents) / 100).toLocaleString("pt-BR")}
			</div>
		  </a>`;
        }
...
if (document.readyState !== 'loading') {
    ...
    document.addEventListener('DOMContentLoaded', initializeRecs());
}